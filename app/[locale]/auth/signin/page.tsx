      ...
      <div className="max-w-md w-full space-y-8">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-800 rounded-lg p-4">
            ...
            {error === 'OAuthAccountNotLinked' && t('errors.oauthAccountNotLinked')}
            {error === 'EmailSignin' && t('errors.emailSignin')}
            {error === 'CredentialsSignin' && t('errors.credentialsSignin')}
            {!['OAuthSignin', 'OAuthCallback', 'OAuthCreateAccount', 'EmailCreateAccount', 'Callback', 'OAuthAccountNotLinked', 'EmailSignin', 'CredentialsSignin'].includes(error) && t('errors.default')}
          </div>
        )}
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg shadow-sm bg-gray-900 hover:bg-gray-800 text-white transition-colors"
          >
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm transition-colors font-medium"
          >
            {t('continueWithEmail')}
          </button>
        </div>
